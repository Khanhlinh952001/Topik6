  ...
  return (
    <main>
      <div className="bg-white ">
        ...
        <div className="lg:h-[60px] bg-white border-b border-gray-300 ">
          <div className="container flex  justify-between pb-2">
            ...
            <div className="flex items-center ml-5">
              ...
              <h2 className="text-[#e5441a] font-bold mt-4 ml-2 hiddenC">
                Thi Thử Topik
              </h2>
            </div>
            ...
            <div className="flex mt-4">
              ...
              <Link href="/pages/Listen">
                <h3 className="text-gray-800 text-lg hover:bg-[#e5441a] fontSM hover:text-white px-3 pt-1 h-8 mx-2 rounded">
                  Kiểm tra nghe
                </h3>
              </Link>
            ...
            {/* Auth Buttons */}
            <div className="lg:flex items-center mt-4 hiddenC">
        ...
        <div className="sm:block md:flex lg:flex bg-white justify-around topSM">
          {/*  */}
          <div>
            ...
            <p className="text-gray-800 mt-2 text-lg  sm:px-5 pxSM md:px-5">
