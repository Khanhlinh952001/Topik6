        ...
        <div className="bg-white p-14 rounded flex flex-col items-center">
          ...
          <div className="flex flex-col items-center">
            <Link href={"/pages/Listen"}>
              <button
                type="button"
                className=" rounded-xl px-6 py-2 w-32 bg-gradient-to-l from-cyan-500 to-blue-500 mb-4"
              >
                Listen
              </button>
            </Link>
            <Link href={"/pages/Reading"}>
              <button
                type="button"
                className=" rounded-xl px-6 py-2 w-32 bg-gradient-to-r from-cyan-500 to-blue-500 "
              >
                Reading
              </button>
            </Link>
